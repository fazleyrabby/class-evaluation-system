                                    ...
                                    <div class="panel-body">
                                         ...
                                         if (isset($_GET['id'])) {
                                          ...
                                          <input type="hidden" name="id" value="<?=$id?>">
                                            ...
                                            <div class="col-lg-9"><input type="text" name="section_name" value="<?php echo $row['section_name'];?>" placeholder="section Name" class="form-control"> 
                                            </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-offset-3 col-lg-9">
                                                    <input type="submit" class="btn btn-sm btn-primary" name="update_section" value="submit">
