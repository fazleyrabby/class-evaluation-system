                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                      <?php
                                                        ...
                                                        elseif ($row['status'] == 0) {
                                                          $status = 'Pending';
                                                          $status_table = "<a onclick=\"return confirm('Are you sure want to activate?')\" href='".$base."/sql/update_sql.php?status=".$row['status']."&&id=".$row['member_id']."&&type=3' class='btn btn-success'>
                                                          Active
                                                          </a>";
                                                          $reject="<a onclick=\"return confirm('Are you sure want to reject this user?')\" href='".$base."/sql/update_sql.php?status=2&&id=".$row['member_id']."&&type=3' class='btn btn-danger'>
                                                          Reject
                                                          </a>";
                                                        }
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a href="update_student.php?id=<?php echo $row['member_id']?>"class="btn btn-success">
                                                            Details
                                                        </a>
                                                        <!-- <a onclick="return confirm('Are you sure want to delete')" href="<?=$base?>/sql/delete_sql.php?delete=delete_student&&id=</?php echo $row['member_id']?>" data-toggle="tooltip" title="" class="btn btn-danger" data-original-title="Delete">
                                                            Delete
                                                        </a> -->
                                                    </td>
                                                </tr>
