                                    ...
                                    <?php 
                                          ...
                                          if($query->num_rows > 0) {
                                            ...
                                            <select name="number_of_class" class="form-control" id="">
                                              <?php 
                                              $sql2 = "SELECT class_no from course_outline where assign_class_id=$a_class_id";
                        ...
                        <div class="col-md-10 col-md-offset-1"><div class="panel panel-card margin-b-30 m-4">
                              ...
                              <div class="table-responsive">
                                            <table id="basic-datatables" class="table table-bordered" style="table-layout:fixed">
                                                ...
                                                from course_outline where assign_class_id = $a_class_id ";
                                                ...
                                                <tr>
                                                    ...
                                                    <td>  <a href="update_class.php?id=<?php echo $row['a_class_id']?>"class="btn btn-info">
                                                        Edit
                                                     </a></td>
                                                </tr>
